...
void GameOverState::Init()
{
    ...
    _gameOverTitle.setPosition(_data->window.getSize().x / 2 - _gameOverTitle.getGlobalBounds().width / 2,
        _data->window.getSize().y / 2 - _gameOverTitle.getGlobalBounds().height * 4);

    _gameOverBody.setPosition(_data->window.getSize().x / 2 - _gameOverTitle.getGlobalBounds().width / 2,
        _data->window.getSize().y / 2 - _gameOverBody.getGlobalBounds().height);
    ...
    _playAgain.setPosition(_data->window.getSize().x / 2 - _gameOverTitle.getGlobalBounds().width/1.5,
                             360);
    ...
    _backToMainMenu.setPosition(_data->window.getSize().x / 2 - _gameOverTitle.getGlobalBounds().width,
                            450);
